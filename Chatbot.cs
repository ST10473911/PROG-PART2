...
namespace CybersecurityChatbotGUI
{
    public class Chatbot
    {
        ...
        public Chatbot()
        {
            ...
            {
                connectionString = "Server=localhost;Database=cybersecurity_bot;Uid=root;Pwd=;";
            }
        ...
        private string GetIntent(string input)
        {
            ...
            {
                if (input.IndexOf(intent.Key, StringComparison.OrdinalIgnoreCase) >= 0)
                {
                    return intent.Value;
                }
            }
        ...
        public string ProcessInput(string input)
        {
            ...
            // Recall memory
            if (input.IndexOf("my name", StringComparison.OrdinalIgnoreCase) >= 0 ||
            ...
            if (input.IndexOf("my interest", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("interested in", StringComparison.OrdinalIgnoreCase) >= 0)
            {
        ...
        private string HandleAddTask(string input)
        {
            ...
            else if (input.IndexOf("reminder", StringComparison.OrdinalIgnoreCase) >= 0 ||
                     input.IndexOf("remind", StringComparison.OrdinalIgnoreCase) >= 0)
            {
        ...
        {
            if (input.IndexOf("quit", StringComparison.OrdinalIgnoreCase) >= 0 || input.IndexOf("exit", StringComparison.OrdinalIgnoreCase) >= 0)
            {
                quizActive = false;
     ...
     \ \_______\ \__\ \__\ \__\ \__\ \_______\
      \|_______|\|__|\|__|\|__|\|__|\|_______|
        ...
        private string HandleFollowUp(string input)
        {
            ...
            {
                if (input.IndexOf(followUp, StringComparison.OrdinalIgnoreCase) >= 0)
                {
                    var topicKey = keywordResponses.Keys.FirstOrDefault(k =>
                        lastTopic.IndexOf(k, StringComparison.OrdinalIgnoreCase) >= 0 ||
                        k.IndexOf(lastTopic, StringComparison.OrdinalIgnoreCase) >= 0);
        ...
        private string DetectSentiment(string input)
        {
            if (input.IndexOf("worried", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("anxious", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("nervous", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("concerned", StringComparison.OrdinalIgnoreCase) >= 0)
                return "worried";
            if (input.IndexOf("scared", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("terrified", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("fear", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("afraid", StringComparison.OrdinalIgnoreCase) >= 0)
                return "scared";
            if (input.IndexOf("frustrated", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("annoyed", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("angry", StringComparison.OrdinalIgnoreCase) >= 0)
                return "frustrated";
            if (input.IndexOf("curious", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("interested", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("want to learn", StringComparison.OrdinalIgnoreCase) >= 0)
                return "curious";
            if (input.IndexOf("confused", StringComparison.OrdinalIgnoreCase) >= 0 ||
                input.IndexOf("don't understand", StringComparison.OrdinalIgnoreCase) >= 0)
                return "confused";
            return null;
        }
